...
my @ns = (    #
	[ NS_PROJECT,  'User:mastiBot/listy/meta' ],
	[ NS_HELP,     'User:mastiBot/listy/pomoc' ],
	[ NS_FILE,     'User:mastiBot/listy/pliki' ],
	[ NS_CATEGORY, 'User:mastiBot/listy/kategorie' ],
);
...
sub listTemplates {
	...
	foreach my $name ( keys %templates ) {
		...
		delete $backlinks{'Wikiskryba:mastiBot/listy/szablony'};
		delete $backlinks{'Wikipedysta:mastiBot/listy/szablony'};
...
EOF
	...
	$api->edit(
		'title' => 'User:mastiBot/listy/szablony',
		'text'  => $report,
	);
}
